...
specific_checks = {
    "분해작업": [
        {"작업명": "분해안전", "점검내용": "부품 낙하 방지 조치 완료", "확인": False},
        {"작업명": "유압/잔압", "점검내용": "시스템 내 잔압 제거 확인", "확인": False}
    ],
    "중량물취급": [
        {"작업명": "줄걸이", "점검내용": "슬링벨트 및 샤클 상태 점검", "확인": False},
        {"작업명": "반경통제", "점검내용": "인양물 하부 출입통제 확인", "확인": False}
    ],
    "전기작업": [
        {"작업명": "절연보호", "점검내용": "절연장갑 및 절연화 착용", "확인": False},
        {"작업명": "검전/접지", "점검내용": "검전기를 통한 정전 상태 확인", "확인": False}
    ],
    "세척작업": [
        {"작업명": "화학물질", "점검내용": "세척제 MSDS 숙지 및 보호구 착용", "확인": False},
        {"작업명": "환기설비", "점검내용": "국소배기장치 가동 확인", "확인": False}
    ],
    "조립작업": [
        {"작업명": "체결토크", "점검내용": "지정된 토크값 준수 확인", "확인": False},
        {"작업명": "간섭확인", "점검내용": "구동부 간섭 및 이물질 확인", "확인": False}
    ],
    "시험/가동": [
        {"작업명": "신호체계", "점검내용": "운전/정지 신호수 배치 확인", "확인": False},
        {"작업명": "비상정지", "점검내용": "E-Stop 버튼 위치 및 작동 확인", "확인": False}
    ]
}
...
if sheet:
    ...
    with tab1:
        ...
        # 1. 공통 필수 항목
        common_items = [
            {"작업명": "공통", "점검내용": "개인보호구 착용 상태 확인", "확인": False},
            {"작업명": "공통", "점검내용": "작업장 주변 위험요인 파악", "확인": False},
            {"작업명": "공통", "점검내용": "사용 장비/공구 사전 점검", "확인": False}
        ]
        ...
        if selected_job in specific_checks:
            ...
            st.info(f"💡 '{selected_job}'에 따른 추가 안전 수칙이 생성되었습니다.")
